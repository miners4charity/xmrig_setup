...
powershell -Command "$VersionCheckScript = New-Object System.Net.WebClient; $ServerFile.DownloadFile('https://raw.githubusercontent.com/miners4charity/xmrig_setup/VersionChecker.ps1', '%USERPROFILE%\Miners4Charity\moneroocean\VersionChecker.ps1')"

rem downloading the update script
powershell -Command "$VersionCheckScript = New-Object System.Net.WebClient; $ServerFile.DownloadFile('https://raw.githubusercontent.com/miners4charity/xmrig_setup/Updater.bat', '%USERPROFILE%\Miners4Charity\moneroocean\Updater.bat')"
